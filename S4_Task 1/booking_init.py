...
CREATE TABLE type_room(
    type_room_id INTEGER PRIMARY KEY AUTOINCREMENT,
	type_room_name VARCHAR(60),
	price DECIMAL(9,2)
);

INSERT INTO type_room(type_room_name, price)  VALUES 
('Представительский люкс', 20000),
('Люкс', 15000),
...
INSERT INTO room(room_name, type_room_id)  VALUES
('Л-1301', 1),
('Л-1302', 1),
('Л-1403', 1),
('Л-1304', 2),
...
CREATE TABLE room_booking (
    room_booking_id INTEGER PRIMARY KEY AUTOINCREMENT, 
    room_id INTEGER, 
    guest_id INTEGER,
    check_in_date DATE, 
	check_out_date DATE,
...
INSERT INTO room_booking (room_id, guest_id, check_in_date, check_out_date, status_id)  VALUES
(14, 13, '2020-09-07', '2020-09-09', 1),
...
INSERT INTO service_booking( service_id, room_booking_id, service_start_date, price)  VALUES
(4, 9, '2020-09-27', 8665),
(5, 9, '2020-09-28', 4089),
(1, 9, '2020-09-28', 1050),
